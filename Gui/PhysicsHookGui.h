#ifndef PhysicsHookGui_H
#define PhysicsHookGui_H
...
{
public:
    PhysicsHookGui() : sim_thread(NULL), please_pause(false), please_die(false), running(false)
    {
    }

    virtual ~PhysicsHookGui()
    {
        killSimThread();
    }
    ...
    void reset()
    {
        ...
        sim_thread = new std::thread(&PhysicsHookGui::runSimThread, this);
    }
